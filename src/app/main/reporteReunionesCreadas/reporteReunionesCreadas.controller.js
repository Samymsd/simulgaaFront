(function ()
{
    ...
    angular
        ...
        .controller('ReporteReunionesCreadasController', ReporteReunionesCreadasController);

    /** @ngInject */
    function ReporteReunionesCreadasController($scope, $mdSidenav, AgendaService, msUtils, $mdDialog,DialogFactory, $document)
    {
        ...
        function GetReuniones() {
            var promiseGet = AgendaService.getReunionesCreadas(user._getIdUsuario());
            promiseGet.then(
                function (data) {
