    ...
    function CalendarioController($mdDialog, $document,AgendaService)
    {
        ...
        function showEventDetailDialog(calendarEvent, e)
        {
            $mdDialog.show({
                ...
                controllerAs       : 'vm',
                templateUrl        : 'app/main/calendario/dialogs/event-detail/event-detail-dialog.html',
        ...
        function showEventFormDialog(type, calendarEvent, start, end, e)
        {
            ...
            $mdDialog.show({
                ...
                controllerAs       : 'vm',
                templateUrl        : 'app/main/calendario/dialogs/event-form/event-form-dialog.html',
                parent             : angular.element($document.body),
                targetEvent        : e,
                clickOutsideToClose: true,
                locals             : {
